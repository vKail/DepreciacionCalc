...
export function downloadCSV(
  ...
  if ("factor" in data[0]) {
    // Suma de Dígitos
    csv = `${unit === "years" ? "Año" : "Mes"},Factor,Porcentaje,Valor Activo,Cuota Depreciación,Depreciación Acumulada,Valor Neto en Libros\n`;
    ...
    // Reducción de Saldos
    csv = `${unit === "years" ? "Año" : "Mes"},Tasa de Depreciación,Valor sin Depreciar,Cuota Depreciación,Depreciación Acumulada,Valor Neto en Libros\n`;
    ...
    csv = `${unit === "years" ? "Año" : "Mes"},Unidades Producidas,Depreciación por Unidad,Cuota Depreciación,Depreciación Acumulada,Valor Neto en Libros\n`;
    ...
    // Línea Recta
    csv = `${unit === "years" ? "Año" : "Mes"},Cuota de Depreciación,Depreciación Acumulada,Valor Neto en Libros\n`;
