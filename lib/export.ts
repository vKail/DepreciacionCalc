...
export function downloadCSV(
  ...
  if ("factor" in data[0]) {
    // Suma de Dígitos
    csv = `${unit === "years" ? "Año" : unit === "months" ? "Mes" : unit === "weeks" ? "Semana" : "Día"},Factor,Porcentaje,Valor Activo,Cuota Depreciación,Depreciación Acumulada,Valor Neto en Libros\n`;
    ...
    // Reducción de Saldos
    csv = `${unit === "years" ? "Año" : unit === "months" ? "Mes" : unit === "weeks" ? "Semana" : "Día"},Tasa de Depreciación,Valor sin Depreciar,Cuota Depreciación,Depreciación Acumulada,Valor Neto en Libros\n`;
    ...
    csv = `${unit === "years" ? "Año" : unit === "months" ? "Mes" : unit === "weeks" ? "Semana" : "Día"},Unidades Producidas,Depreciación por Unidad,Cuota Depreciación,Depreciación Acumulada,Valor Neto en Libros\n`;
    ...
    // Línea Recta
    csv = `${unit === "years" ? "Año" : unit === "months" ? "Mes" : unit === "weeks" ? "Semana" : "Día"},Cuota de Depreciación,Depreciación Acumulada,Valor Neto en Libros\n`;
